/*
18. A Game of 21
For this assigment, you will write a program that lets the user play against the computer
...
- At the beginning of each round, the program will ask the users whether they want
  to roll the dice to accumulte points.
...
- The The computer's total should remain hidden until the loop has finished.
