...
void displayInersection(set<string>, set<string>);
...
int main()
{
	...
	displayInersection(baseball, basketball);
...
// The displayInersection function displays the intersection
// of two set<string> objects.
void displayInersection(set<string> set1, set<string> set2)
{
	...
	// Resize the result to remove unused elements.
...
// displayDifference function displays the difference
// of two set<string> objects.
...
// displaySymmetricDifference function displays the 
