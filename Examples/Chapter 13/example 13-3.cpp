...
int main()
{
	...
	Rectangle* kitchen = nullptr; // To point to kitchen dimenstions
	Rectangle* bedroom = nullptr; // To point to bedroom dimenstions
	Rectangle* den = nullptr;     // To point to den dimenstions
	...
	// Delete thes object from memory.
	delete kitchen;
	delete bedroom;
	delete den;
	kitchen = nullptr; // Make kitchen a null pointer
	bedroom = nullptr; // Make kitchen a null pointer
	den = nullptr;     // Make kitchen a null pointer
